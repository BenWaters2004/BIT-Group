...
<head>
    ...
    <title>Our Cyber Technology Solutions</title>
    <meta name="keywords" content="BIT, Bluescreen, Cyber Security, Partnerships, Solutions, Southwest, Password Management, detection and response, threat, incident, email, phishing, training, hornet, AT&T, keeper, crowdstrike, knowbe4" />
    <meta name="description" content="Learn about our technology solutions, how we can protect you and what we can provide you with."/>
...
<body>
    <div class="margins">
        ...
        <div class="Title-TextBlock">
            <h2>Technical Solutions we implement as <span>part of our fully managed support service offering</span></h2>
            <p>By incorporating cyber technology solutions like Hornet Security, KnowBe4, CrowdStrike, and Heimdal as part of our managed service, our security company aims to deliver an exceptional level of protection and peace of mind to our customers. With Hornet security, we ensure that your sensitive information remains secure by implementing robust email security and advanced threat protection measures. Through KnowBe4, we offer comprehensive security awareness training and simulated phishing campaigns, equipping your employees with the knowledge and skills to identify and respond to potential threats effectively. With CrowdStrike’s cutting-edge endpoint protection capabilities, we provide proactive threat detection and rapid incident response to keep your systems safe from cyber attacks.</p>
        </div>
